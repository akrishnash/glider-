...
export default function SignUp({ onToggleMode, onSuccess }: SignUpProps) {
      ...
      >
        <div className="bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white mb-2">Join ApplyAI</h1>
            <p className="text-slate-400">Start automating your job applications</p>
          </div>
